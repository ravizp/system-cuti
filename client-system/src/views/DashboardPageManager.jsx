...
export default function DashboardPageManager({ url }) {
  ...
  const fetchLeaves = async () => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:3000/leaves-manager-hrd", {
        headers: {
  ...
  const handleApprove = (id) => {
    handleStatusUpdate(id, "Approve Manager HRD");
  };
